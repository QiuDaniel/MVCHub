...
-(void)successStyle{
    ...
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:0.34 green:0.42 blue:0.46 alpha:1.0]] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:0.34 green:0.42 blue:0.46 alpha:0.8]] forState:UIControlStateDisabled];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:@"0x2f434f"]] forState:UIControlStateHighlighted];
    [self setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
