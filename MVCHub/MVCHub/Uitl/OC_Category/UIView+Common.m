...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _monkeyView = [[UIImageView alloc] initWithImage:[UIImage octicon_imageWithIcon:@"LogoGithub" backgroundColor:[UIColor clearColor] iconColor:[UIColor blackColor] iconScale:1 andSize:CGSizeMake(35, 35)]];
